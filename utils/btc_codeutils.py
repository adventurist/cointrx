...
class TrxUtils:
    ...
    class TestUtils(unittest.TestCase):
        def test_varint(self):
            self.assertEqual(self.varint(0x42), '\x42')
            self.assertEqual(self.varint(0x123), '\xfd\x23\x01')
            self.assertEqual(self.varint(0x12345678), '\xfe\x78\x56\x34\x12')
            self.assertEqual(self.processVarInt(self.varint(0x42)), [0x42, 1])
            self.assertEqual(self.processVarInt(self.varint(0x1234)), [0x1234, 3])
